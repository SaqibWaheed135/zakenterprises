...
import { Phone, Mail, MapPin, Clock, Shield, Trash2 } from 'lucide-react';
...
const ContactSection = () => (
  <div className="min-h-screen bg-white py-16">
    <div className="container mx-auto px-4">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Shop No.57, 1st Floor, Liberty Plaza, Liaquat Road, Opposite Gordan College,
      ...
      <div className="mt-20 bg-red-50 p-8 rounded-lg shadow-lg max-w-4xl mx-auto">
        <div className="flex items-center space-x-3 mb-4">
          <Trash2 className="w-6 h-6 text-red-600" />
          <h3 className="text-2xl font-semibold text-gray-800">Account Deletion Policy</h3>
        </div>
        ...
        <ul className="list-disc list-inside text-gray-700 ml-4 mb-4">
          <li>Email: <span className="font-medium">zakenterprises135@gmail.com</span></li>
          <li>Subject line: <span className="font-medium">Account Deletion Request</span></li>
        </ul>
        <p className="text-gray-600 text-sm">
          We will process your request within 7 business days and confirm once your data has been permanently removed.
        </p>
      </div>
    </div>
  </div>
